...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/organizacion'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [OrganizacionRUCEController::class, 'index'])->name('organizacion.index');
        Route::middleware('role:super_admin|admin')->post('/', [OrganizacionRUCEController::class, 'store'])->name('organizacion.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [OrganizacionRUCEController::class, 'show'])->name('organizacion.show');
        Route::middleware('role:super_admin|admin')->delete('/{id}', [OrganizacionRUCEController::class, 'destroy'])->name('organizacion.destroy');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/cooperadora'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [CooperadoraController::class, 'index'])->name('cooperadora.index');
        Route::middleware('role:super_admin|admin')->post('/', [CooperadoraController::class, 'store'])->name('cooperadora.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [CooperadoraController::class, 'show'])->name('cooperadora.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/atencion_seguimiento'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [AtencionSeguimientoController::class, 'index'])->name('atencion_seguimiento.index');
        Route::middleware('role:super_admin|admin')->post('/', [AtencionSeguimientoController::class, 'store'])->name('atencion_seguimiento.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [AtencionSeguimientoController::class, 'show'])->name('atencion_seguimiento.show');
        ...
        Route::middleware('role:super_admin|admin')->put('/{id}', [AtencionSeguimientoController::class, 'update'])->name('atencion_seguimiento.update');
    });
});

Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/autoridad_comision'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [AutoridadComisionController::class, 'index'])->name('autoridad_comision.index');
        Route::middleware('role:super_admin|admin')->post('/', [AutoridadComisionController::class, 'store'])->name('autoridad_comision.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [AutoridadComisionController::class, 'show'])->name('autoridad_comision.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/autoridad_organizacion'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [AutoridadOrganizacionRUCEController::class, 'index'])->name('autoridad_organizacion.index');
        ...
        Route::middleware('role:super_admin|admin')->get('/{id}', [AutoridadOrganizacionRUCEController::class, 'show'])->name('autoridad_organizacion.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/balance', 'middleware' => ['role:super_admin']], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [BalanceController::class, 'index'])->name('balance.index');
        Route::middleware('role:super_admin|admin')->post('/', [BalanceController::class, 'store'])->name('balance.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [BalanceController::class, 'show'])->name('balance.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/comision'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [ComisionController::class, 'index'])->name('comision.index');
        Route::middleware('role:super_admin|admin')->post('/', [ComisionController::class, 'store'])->name('comision.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [ComisionController::class, 'show'])->name('comision.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/expediente'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [ExpedienteController::class, 'index'])->name('expediente.index');
        Route::middleware('role:super_admin|admin')->post('/', [ExpedienteController::class, 'store'])->name('expediente.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [ExpedienteController::class, 'show'])->name('expediente.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/fondo'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [FondoController::class, 'index'])->name('fondo.index');
        Route::middleware('role:super_admin|admin')->post('/', [FondoController::class, 'store'])->name('fondo.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [FondoController::class, 'show'])->name('fondo.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/kiosco'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [KioscoController::class, 'index'])->name('kiosco.index');
        Route::middleware('role:super_admin|admin')->post('/', [KioscoController::class, 'store'])->name('kiosco.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [KioscoController::class, 'show'])->name('kiosco.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/matricula'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [MatriculaController::class, 'index'])->name('matricula.index');
        Route::middleware('role:super_admin|admin')->post('/', [MatriculaController::class, 'store'])->name('matricula.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [MatriculaController::class, 'show'])->name('matricula.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/persona_ruce'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [PersonaRUCEController::class, 'index'])->name('persona_ruce.index');
        Route::middleware('role:super_admin|admin')->post('/', [PersonaRUCEController::class, 'store'])->name('persona_ruce.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [PersonaRUCEController::class, 'show'])->name('persona_ruce.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/personeria'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [PersoneriaController::class, 'index'])->name('personeria.index');
        Route::middleware('role:super_admin|admin')->post('/', [PersoneriaController::class, 'store'])->name('personeria.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [PersoneriaController::class, 'show'])->name('personeria.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/instancia_instrumento'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [RefInstanciaInstrumentoController::class, 'index'])->name('instancia_instrumento.index');
        ...
        Route::middleware('role:super_admin|admin')->get('/{id}', [RefInstanciaInstrumentoController::class, 'show'])->name('instancia_instrumento.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/tipo_asociacion'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [RefTipoAsociacionController::class, 'index'])->name('tipo_asociacion.index');
        Route::middleware('role:super_admin|admin')->post('/', [RefTipoAsociacionController::class, 'store'])->name('tipo_asociacion.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [RefTipoAsociacionController::class, 'show'])->name('tipo_asociacion.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/tipo_comision'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [RefTipoComisionController::class, 'index'])->name('tipo_comision.index');
        Route::middleware('role:super_admin|admin')->post('/', [RefTipoComisionController::class, 'store'])->name('tipo_comision.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [RefTipoComisionController::class, 'show'])->name('tipo_comision.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/tipo_documento'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [RefTipoDocumentoRUCEController::class, 'index'])->name('tipo_documento.index');
        Route::middleware('role:super_admin|admin')->post('/', [RefTipoDocumentoRUCEController::class, 'store'])->name('tipo_documento.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [RefTipoDocumentoRUCEController::class, 'show'])->name('tipo_documento.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/tipo_fondo'], function () {
        Route::middleware('role:super_admin|admin')->get('/Filter', [RefTipoFondoController::class, 'index'])->name('tipo_fondo.index');
        Route::middleware('role:super_admin|admin')->post('/', [RefTipoFondoController::class, 'store'])->name('tipo_fondo.store');
        Route::middleware('role:super_admin|admin')->get('/{id}', [RefTipoFondoController::class, 'show'])->name('tipo_fondo.show');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::group(['prefix' => '/usuario'], function () {
        Route::middleware('role:super_admin')->get('/Filter', [UsuarioRUCEController::class, 'index'])->name('usuario.index');
        Route::middleware('role:super_admin')->post('/', [UsuarioRUCEController::class, 'store'])->name('usuario.store');
        Route::middleware('role:super_admin')->get('/{id}', [UsuarioRUCEController::class, 'show'])->name('usuario.show');
