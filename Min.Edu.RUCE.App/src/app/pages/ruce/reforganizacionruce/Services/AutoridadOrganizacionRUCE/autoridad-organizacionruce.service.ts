...
export class AutoridadOrganizacionRUCEService {
  ...
  public create(autoridad: AutoridadOrganizacionRUCEModel): Observable<any> {
    const httpOptions = {
      method: 'POST',
      headers: new HttpHeaders({
  ...
  public update(id: number, autoridad: AutoridadOrganizacionRUCEModel) {
    const httpOptions = {
      method: 'PUT',
      headers: new HttpHeaders({
        'Content-Type': 'application/json',
